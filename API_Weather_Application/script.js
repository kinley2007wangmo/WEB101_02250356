...
const WEATHER_API_KEY = '544e395fb9bc413fb14e6c687a1d7384'; // 544e395fb9bc413fb14e6c687a1d7384
...
async function getWeather() {
    ...
    try {
        ...
        <button id="quick-save" style="background:#27ae60;">Save This Location</button>
        `;
        ...
        document.getElementById('quick-save').addEventListener('click', () => {
            ...
            document.getElementById('location-notes').value = `Temp: ${data.main.temp}°C`;
...
async function saveLocation() {
    ...
    if (!name || !city) {
        alert('Please enter atleast name and city');
        return;
    }
    ...
    try {
        ...
        const locationData = {
            ...
            userId: 1// This is just for JSONPlaceloder API
        };
...
async function fetchSavedLocations() {
    try {
        // This is a GET request toJSONPlaceholder
        const response = await fetch(`${PLACEHOLDER_API_URL}?userId=1`);
        const data = await response.json();

        // Transform the data to ourformat - onlytake first 5 items
